/*
proc sql;
   CREATE TABLE SM_TMP.TPT_CARD_OSP as 
	    SELECT   		  		  A.ID_REV_CLASICO,
	                              ...
	                              B.IMP_CREDITO,
	                              B.TIPO_INTERES
	    FROM        R_SID2.CTO_REV_CLASICO  a, R_SID2.CTO_CLASICO b, R_SID2.CTO_REVOLVING c
	...
	UNION ALL
	    ...
	    SELECT   				A.ID_REV_CLASICO,
	                            ...
	                            B.IMP_CREDITO,
	                            B.TIPO_INTERES
	    FROM        R_SID2.CTO_REV_CLASICO_HM a, R_SID2.CTO_CLASICO_HM  b, R_SID2.CTO_REVOLVING_HM c
...
data SM_TMP.TPT_CARD_OSP;
      format account_id_tj account_id_tpt 14. finan_date ddmmyy10.;
      set SM_TMP.TPT_CARD_OSP   (rename=(IMP_CREDITO=oa_amt));
...
proc sort data= SM_TMP.TPT_CARD_OSP nodupkey;
